...
English for Knowledge Representation,'' in \emph{Reasoning Web}, 2008.
\bibitem{hdt} J. D. Fern\'andez et al., ``Binary RDF Representation for
Publication and Exchange (HDT),'' \emph{J. Web Semantics}, 2013.
\bibitem{wl} B. Weisfeiler and A. Leman, ``The reduction of a graph to canonical
form and the algebra which appears therein,'' 1968.
\bibitem{cd} L. Beurer-Kellner, M. Fischer, and M. Vechev, ``Guiding LLMs the
Right Way: Fast, Non-Invasive Constrained Generation,'' in \emph{ICML}, 2024.
\end{thebibliography}
